...
echo.
if "%C%"=="startwsl" C:\Users\Administrator\Desktop\MAT\tools\wsl.bat goto start
if "%C%"=="startbruteforcer" echo plugin directory C:\Users\Administrator\Desktop\MAT\tools\BruteForcer_091\Client\Plugins start C:\Users\Administrator\Desktop\MAT\tools\BruteForcer_091\Client\BFC.exe goto start
if "%C%"=="startipscanner" C:/users/Administrator/Desktop/MAT/tools/Networkipscanner.bat goto start
...
:cctv
C:\Users\Administrator\Desktop\MAT\camera\cam.html
goto start
...
:open_roblox
C:\Users\Administrator\AppData\Local\Roblox\Versions\version-0137f7d4848f436a\RobloxPlayerBeta.exe"
%speech% Opening...
echo Opening...
...
:chrometime
C:\Users\Administrator\Desktop\Google_Chrme.lnk
